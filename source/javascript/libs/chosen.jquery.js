...
(function() {
  ...
  $.fn.extend({
    chosen: function(options) {
      ...
      return $(this).each(function(input_field) {
        if (!($(this)).hasClass("hrvst-chzn-done")) return new Chosen(this, options);
      });
    }
  });
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.setup = function() {
      ...
      return this.is_rtl = this.form_field_jq.hasClass("hrvst-chzn-rtl");
    };

    Chosen.prototype.finish_setup = function() {
      return this.form_field_jq.addClass("hrvst-chzn-done");
    };

    Chosen.prototype.set_up_html = function() {
      var container_div, dd_top, dd_width, sf_width;
      this.container_id = this.form_field.id.length ? this.form_field.id.replace(/(:|\.)/g, '_') : this.generate_field_id();
      this.container_id += "_hrvst-chzn";
      this.f_width = this.form_field_jq.outerWidth();
      this.default_text = this.form_field_jq.data('placeholder') ? this.form_field_jq.data('placeholder') : this.default_text_default;
      container_div = $("<div />", {
        id: this.container_id,
        "class": "hrvst-chzn-container" + (this.is_rtl ? ' hrvst-chzn-rtl' : ''),
        style: 'width: ' + this.f_width + 'px;'
      });
      if (this.is_multiple) {
        container_div.html('<ul class="hrvst-chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="hrvst-chzn-drop" style="left:-9000px;"><ul class="hrvst-chzn-results"></ul></div>');
      } else {
        container_div.html('<a href="javascript:void(0)" class="hrvst-chzn-single"><span>' + this.default_text + '</span><div><b></b></div></a><div class="hrvst-chzn-drop" style="left:-9000px;"><div class="hrvst-chzn-search"><input type="text" autocomplete="off" /></div><ul class="hrvst-chzn-results"></ul></div>');
      }
      this.form_field_jq.hide().after(container_div);
      this.container = $('#' + this.container_id);
      this.container.addClass("hrvst-chzn-container-" + (this.is_multiple ? "multi" : "single"));
      this.dropdown = this.container.find('div.hrvst-chzn-drop').first();
      ...
      this.search_results = this.container.find('ul.hrvst-chzn-results').first();
      this.search_field_scale();
      this.search_no_results = this.container.find('li.no-results').first();
      if (this.is_multiple) {
        this.search_choices = this.container.find('ul.hrvst-chzn-choices').first();
        this.search_container = this.container.find('li.search-field').first();
      } else {
        this.search_container = this.container.find('div.hrvst-chzn-search').first();
        this.selected_item = this.container.find('.hrvst-chzn-single').first();
    ...
    Chosen.prototype.search_field_disabled = function() {
      ...
      if (this.is_disabled) {
        this.container.addClass('hrvst-chzn-disabled');
        ...
        this.container.removeClass('hrvst-chzn-disabled');
      ...
      if (!this.is_disabled) {
        ...
        if (!this.pending_destroy_click && !target_closelink) {
          if (!this.active_field) {
            ...
            this.results_show();
          } else if (!this.is_multiple && evt && (($(evt.target)[0] === this.selected_item[0]) || $(evt.target).parents("a.hrvst-chzn-single").length)) {
            evt.preventDefault();
            this.results_toggle();
          }
    ...
    Chosen.prototype.blur_test = function(evt) {
      if (!this.active_field && this.container.hasClass("hrvst-chzn-container-active")) {
        return this.close_field();
      }
    };
    ...
    Chosen.prototype.close_field = function() {
      ...
      this.active_field = false;
      this.results_hide();
      this.container.removeClass("hrvst-chzn-container-active");
    ...
    Chosen.prototype.activate_field = function() {
      ...
      this.container.addClass("hrvst-chzn-container-active");
    ...
    Chosen.prototype.results_build = function() {
      ...
      if (this.is_multiple && this.choices > 0) {
        ...
        if (this.form_field.options.length <= this.disable_search_threshold) {
          this.container.addClass("hrvst-chzn-container-single-nosearch");
        } else {
          this.container.removeClass("hrvst-chzn-container-single-nosearch");
        }
      }
      content = '';
    ...
    Chosen.prototype.results_show = function() {
      var dd_top;
      if (!this.is_multiple) {
        this.selected_item.addClass("hrvst-chzn-single-with-drop");
    ...
    Chosen.prototype.results_hide = function() {
      if (!this.is_multiple) {
        this.selected_item.removeClass("hrvst-chzn-single-with-drop");
      }
      this.result_clear_highlight();
      this.dropdown.css({
        "left": "-9000px"
